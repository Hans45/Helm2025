...
#include "mopo.h"
#include "helm2025_voice_handler.h"
#include "helm2025_common.h"
#include "midi_event.h"
#include "midi_queue.h"
#include "helm2025_module.h"
...
namespace mopo {
  ...
  // Suppression des doublons de getLfo1/getLfo2 ici (définis publiquement ci-dessous)
    public:
      HelmLfo* getLfo1() const { return lfo_1_; }
      HelmLfo* getLfo2() const { return lfo_2_; }
      ...
      HelmLfo* getPolyLfo() const { return voice_handler_ ? voice_handler_->getPolyLfo() : nullptr; }
